...
merge_tables(config, {
  ...
  keys = {
    ...
    { mods = "LEADER|SHIFT",      key = "m", action = act.PaneSelect({ mode = "SwapWithActiveKeepFocus" }) },

    { mods = "LEADER|SHIFT",      key = "n", action = act.SpawnTab("CurrentPaneDomain") },
    ...
    { mods = "LEADER|SHIFT",      key = "s", action = act.ActivateKeyTable({ name = "s", one_shot = true, timeout_milliseconds = 1000 }) },
    { mods = "LEADER|SHIFT",      key = "r", action = act.ActivateKeyTable({ name = "r", one_shot = true, timeout_milliseconds = 1000 }) },
  },
  key_tables = {
    s = {
      { mods = "SHIFT",      key = "h", action = act.SplitPane({ direction = "Left" }) },
      { mods = "SHIFT",      key = "j", action = act.SplitPane({ direction = "Down" }) },
      { mods = "SHIFT",      key = "k", action = act.SplitPane({ direction = "Up" }) },
      { mods = "SHIFT",      key = "l", action = act.SplitPane({ direction = "Right" }) },
      { mods = "CTRL|SHIFT", key = "h", action = act.SplitPane({ direction = "Left", command = { args = { "fish" } }, }) },
      { mods = "CTRL|SHIFT", key = "j", action = act.SplitPane({ direction = "Down", command = { args = { "fish" } }, }) },
      { mods = "CTRL|SHIFT", key = "k", action = act.SplitPane({ direction = "Up", command = { args = { "fish" } }, }) },
      { mods = "CTRL|SHIFT", key = "l", action = act.SplitPane({ direction = "Right", command = { args = { "fish" } }, }) },
    },
    r = {
      { mods = "SHIFT",      key = "r", action = act.ReloadConfiguration },
      { mods = "SHIFT",      key = "h", action = act.AdjustPaneSize({ "Left", 6 }) },
      { mods = "SHIFT",      key = "j", action = act.AdjustPaneSize({ "Down", 4 }) },
      { mods = "SHIFT",      key = "k", action = act.AdjustPaneSize({ "Up", 4 }) },
      { mods = "SHIFT",      key = "l", action = act.AdjustPaneSize({ "Right", 6 }) },
      { mods = "CTRL|SHIFT", key = "h", action = act.AdjustPaneSize({ "Left", 1 }) },
      { mods = "CTRL|SHIFT", key = "j", action = act.AdjustPaneSize({ "Down", 1 }) },
      { mods = "CTRL|SHIFT", key = "k", action = act.AdjustPaneSize({ "Up", 1 }) },
      { mods = "CTRL|SHIFT", key = "l", action = act.AdjustPaneSize({ "Right", 1 }) },
    },
  },
